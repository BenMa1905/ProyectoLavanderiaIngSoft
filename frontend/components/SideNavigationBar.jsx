                ...
                <DrawerContent>
                    ...
                    <DrawerBody p={0}>
                        ...
                        <Button
                            ...
                            leftIcon={<PaymentIcon color={ledgerButtCol} w="42" h="42" />}

                            _hover={{ bg: "brand.500" }}
                            onMouseLeave={() => setLedgerButtCol(generalColor)}
                            onMouseEnter={() => setLedgerButtCol("#FFFFFF")}

                            onClick={() => router.push('/Finances')}
                        >


                            <Text mx='auto'>Ver libro</Text>
                        </Button>
                        <Button
                            ...
                            leftIcon={<InventoryIcon color={inventoryButtCol} w="42" h="42" />}

                            _hover={{ bg: "brand.500" }}
                            onMouseLeave={() => setInventoryButtCol(generalColor)}
                            onMouseEnter={() => setInventoryButtCol("#FFFFFF")}

                            onClick={() => router.push('/Supply')}
                        >


                            <Text mx='auto'>Ver suministros</Text>
                        </Button>
                    </DrawerBody>
